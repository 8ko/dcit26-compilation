    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Paragraph style={styles.paragraph}>
          Mary-Belle Kirschner (born 23 October 1999), better known as Belle Delphine, is a South African-born English <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Internet_celebrity')}>Internet celebrity</Text>, <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Pornography')}>pornographic </Text>actress, model, and <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/YouTuber')}>Youtuber</Text>. Her <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Instagram')}>Instagram</Text> account features <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Erotic_photography')}>erotic</Text> and <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Cosplay')}>cosplay</Text> modelling, sometimes blending the two together. Her posts on the platform were often influenced by popular <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Internet_meme')}>memes</Text> and trends. Media outlets have described her as an "<Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/E-girls_and_e-boys')}>e-girl</Text>" and a cross between an <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Internet_troll')}>Internet troll</Text> and a <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Performance_art')}>performance artist</Text>. Delphine has also been cited as an influence on the e-girl style commonly adopted by <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/TikTok')}>TikTok</Text> users.
      </Paragraph>
        <BelleTable />
        <Paragraph style={styles.paragraph}>
          Delphine's online persona began in 2018, through her cosplay modeling on Instagram. In mid–2019, she gained notoriety through creating a satirical <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.m.wikipedia.org/wiki/Pornhub')}>Pornhub</Text> account and selling her "GamerGirl Bath Water" product through her online store. Shortly after, her Instagram account was deleted due to community guideline violations. After a hiatus from October 2019 through June 2020, she started an OnlyFans account, on which she posts adult content. She also began uploading music videos on her YouTube channel, which often functioned as promotions for her <Text style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.m.wikipedia.org/wiki/OnlyFans')}>OnlyFans</Text> account.
        </Paragraph>
