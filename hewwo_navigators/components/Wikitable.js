...
export default class BelleTable extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            tableData: [
                ['  Mary-Belle Kirschner', '\n  23 October 1999', '\n  (age 21)\n', <Text key="south" style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/South_Africa')}>  South Africa</Text>],
                ['  Bunny Delphine'],
            ...
            tableYoutubeData: [
                [ <Text key="yt"style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://www.youtube.com/channel/UCXvKUavCtDOlA8bT1i2tI3w')}>  belle delphine <Feather name="external-link" size={14} color="#FF6961" /></Text>] ,
                ['  2016, 2018-present']
            ],
            tableYoutubeTitle2: ['  Genre', '  Subscribers', '  Total views'],
            tableYoutubeData2: [
                [<Text key="beauty" style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Beauty_YouTuber')}>  Beauty and makeup</Text>, ' ·\n', <Text key="mv" style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Music_video')}>  music</Text>, '  ·  ', <Text key="vlog" style={{ color: '#FF6961' }} onPress={() => Linking.openURL('https://en.wikipedia.org/wiki/Vlog')}>vlog</Text> ],
                ['  1.95 million'],
                ['  46.8 million']
            ],
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Table borderStyle={{ borderWidth: 0.8, borderColor: '#FF6961' }}>
