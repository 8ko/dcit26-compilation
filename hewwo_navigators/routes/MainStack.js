...
const MainNavigator = () => {
  return (
    <NavigationContainer>
      <Drawer.Navigator
        drawerStyle={{ backgroundColor: '#F5F5DD', width: 300 }}
        drawerContentOptions={{ activeTintColor: '#FF6961', inactiveTintColor: '#FF6961' }}
        drawerContent={(props) => {
          return (
      ...
      >
        ...
        <Drawer.Screen
          options={{
          swipeEnabled:false,
            drawerIcon: () => (<Ionicons name="person-outline" size={24} color="#FF6961" />),
          }}
          name="Profile" component={ProfileStack} />
        <Drawer.Screen
          options={{
            swipeEnabled:false,
            drawerIcon: () => (<Ionicons name="image-outline" size={24} color="#FF6961" />),
          }}
          name="Gallery" component={GalleryStack} />
        <Drawer.Screen
          options={{
            swipeEnabled:false,
            drawerIcon: () => (<Feather name="info" size={24} color="#FF6961" />),
          }}
